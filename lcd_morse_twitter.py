#
# Morse code trainer with Twitter capability
...
# Twitter credentials - complete these or it won't work :)
consumer_key = ""
consumer_secret = ""
access_token_key = ""
access_token_secret = ""
...
try:
    ...
    while True:
        ...
        if lcd.select_button:
            lcd.cursor_position(0, 1)
            lcd.message = "Tweeting..."
            api.PostUpdate(message + ' #MorseCode #RaspberryPi')
            lcd.message = "           "
            message = ""
            current_letter = ""
            lcd.clear()
